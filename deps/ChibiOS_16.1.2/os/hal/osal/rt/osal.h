 ...
 *
 * @param[in] time      the delay in system ticks, the special uart_values are
 *                      handled as follow:
 ...
 *
 * @param[in] trp       a pointer to a thread reference object
 * @param[in] timeout   the timeout in system ticks, the special uart_values are
 *                      handled as follow:
 ...
 * @param[in] time      the timeout in system ticks, the special uart_values are
 *                      handled as follow:
 *                      - @a TIME_INFINITE the thread enters an infinite sleep
 *                        state.
 *                      - @a TIME_IMMEDIATE the thread is not enqueued and
