...
cycles. After that it just turns on ICU3 and waits for it to overflow. The uart_values
...
reprogrammed. The uart_values used for fuses are LFUSE=0xe7 and HFUSE=0x99.
